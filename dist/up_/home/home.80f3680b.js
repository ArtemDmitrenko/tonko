...
})({"bwjoO":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "0f65ffd880f3680b";
"use strict";
...
},{}],"hSokC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _home = require("./home");
var _homeDefault = parcelHelpers.interopDefault(_home);
var _homeScss = require("./home.scss");
document.addEventListener("DOMContentLoaded", ()=>{
    new (0, _homeDefault.default)();
});

},{"./home":"cIPEi","./home.scss":"7qQX1","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cIPEi":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _productsSlider = require("../../components/products-slider/products-slider");
var _productsSliderDefault = parcelHelpers.interopDefault(_productsSlider);
var _headerInit = require("../../components/header/header-init");
var _headerInitDefault = parcelHelpers.interopDefault(_headerInit);
var _mainGallery = require("../../components/main-gallery/mainGallery");
var _mainGalleryDefault = parcelHelpers.interopDefault(_mainGallery);
class Home {
    constructor(){
        this.init();
    }
    ...
    initElements() {
        (0, _headerInitDefault.default)(this.handleBurgerMenuClick);
        new (0, _mainGalleryDefault.default)(this.homeGallery);
        this.productsSliders.forEach((slider)=>{
            new (0, _productsSliderDefault.default)(slider);
        });
    }
...
},{"../../components/products-slider/products-slider":"44QUU","../../components/header/header-init":"5ebpi","../../components/main-gallery/mainGallery":"elbAN","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"44QUU":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../../import-jquery":"5NpfD","slick-carousel":"ghMFH","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5NpfD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
 ...
 */ (function(factory) {
    ...
    else module.exports = factory(require("aa2880cb6691ad38"));
})(function($) {
    "use strict";
...
},{"aa2880cb6691ad38":"hgMhh"}],"5ebpi":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _header = require("./header");
var _headerDefault = parcelHelpers.interopDefault(_header);
var _subHeader = require("../sub-header/sub-header");
var _subHeaderDefault = parcelHelpers.interopDefault(_subHeader);
var _headerMinimized = require("../header-minimized/header-minimized");
var _headerMinimizedDefault = parcelHelpers.interopDefault(_headerMinimized);
function HeaderInit(handleBurgerMenuClick) {
    document.querySelectorAll(".js-header").forEach((item)=>{
        new (0, _headerDefault.default)(item, handleBurgerMenuClick);
        new (0, _headerMinimizedDefault.default)(item);
        new (0, _subHeaderDefault.default)(item);
    });
}
exports.default = HeaderInit;

},{"./header":"dYqzq","../sub-header/sub-header":"nnSnC","../header-minimized/header-minimized":"hNGpD","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dYqzq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _mobileSubmenu = require("./mobileSubmenu");
var _mobileSubmenuDefault = parcelHelpers.interopDefault(_mobileSubmenu);
class Header {
    ...
    handleBurgerClick = ()=>{
        ...
        this.mobileSubmenuButtons.forEach((mobileSubmenuButton)=>{
            ...
            new (0, _mobileSubmenuDefault.default)(mobileSubmenuButton, mobileSubmenu);
        });
    };
}
exports.default = Header;

},{"./mobileSubmenu":"iBdQk","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iBdQk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class MobileSubmenu {
    ...
    handleSubButtonClick = ()=>{
        ...
        if (this.mobileSubmenu.style.maxHeight) this.mobileSubmenu.style.maxHeight = null;
        else this.mobileSubmenu.style.maxHeight = this.mobileSubmenu.scrollHeight + "px";
    };
}
exports.default = MobileSubmenu;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"nnSnC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class SubHeader {
    constructor(item){
    ...
    init() {
        ...
        if (this.innerWidth < 1280) $(this.mobileContainer).slick({
            infinite: false,
            arrows: false,
            slidesToShow: 7,
            slidesToScroll: 7,
    ...
    handleMenuButtonClick(i, item) {
        ...
        this.menuButtons.forEach((item, index)=>{
            if (i !== index) item.classList.remove("sub-header__link_active");
        });
    }
}
exports.default = SubHeader;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hNGpD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class HeaderMinimized {
    ...
    handlePageScroll = ()=>{
        ...
        if (window.pageYOffset < scrollOffset) this.closeSubmenu();
    };
    handleMousemoveOnDocument = (e)=>{
        const offset = 130;
        if (e.clientY > offset || window.pageYOffset < 250) this.closeSubmenu();
    };
...
exports.default = HeaderMinimized;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"elbAN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _importJquery = require("../../import-jquery");
var _slickCarousel = require("slick-carousel");
...
},{"../../import-jquery":"5NpfD","slick-carousel":"ghMFH","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7qQX1":[function() {},{}]},["bwjoO","hSokC"], "hSokC", "parcelRequireab2a")

//# sourceMappingURL=home.80f3680b.js.map
